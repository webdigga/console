...
while($accidentrow = mysql_fetch_array($accidents)) {			
	...
	echo "<tr class=\"accident-row driver".$accidentrow['driverid']." ".$accidentrow['vehiclelicenseplate']."\"><td>".$accidentrow['id']."</td><td>".$dateTimeFormatted."</td><td class=\"camera\"><a href=\"/images.php?nav=accidents&accidentid=".$accidentrow['id']."\"><img src=\"/img/camera_go.png\" /></a></td><td>". $accidentrow['drivername'] ."</td><td><a href=\"/third-parties.php?nav=accidents&tpid=".$accidentrow['tpid']."\">". $accidentrow['tpname'] ."</a></td><td>". $accidentrow['vehiclelicenseplate'] ."</td><td>". $accidentrow['thirdpartylicenseplate'] ."</td><td class=\"map\"><a href=\"/map.php?nav=accidents&longlat=".$accidentrow['location']."&location=".$accidentrow['location_standard']."\"><img src=\"/img/map_magnify.png\" /></a></td><td class=\"description\">". $accidentrow['description'] ."</td><td class=\"fa-img\"><a href=\"/further-action.php?nav=accidents&fa=".$accidentrow['faaccid']."\">". $faImg ."</a></td></tr>";
}
echo "</tbody>";